...
public class Trains {
  ...
  public void getTrainsList()
  {
      ...
      try 
      {
          ...
          while (scnr.hasNextInt()) 
          {
        	  ...
        	  getTicket().add(new Trains(Gid, Gdepart, Gdestination, Gprice));        	  
        }
        scnr.close();	        	       
    }
    catch (IOException e) 
  ...
  public Trains(int nID, String nDepart, String nDestination, double nPrice) {
    id = nID;      depart = nDepart;    destination = nDestination;		price = nPrice;
  }

  public String toString() {
    return new String(id+"\t\t"+depart+"\t\t"+destination+"\t\t"+price);
  }
  ...
  public String showTicket() {
  	String s = new String ("id\t\tdepart\t\tdestination\t\tprice\n");
  ...
  void addTicket (int id, String depart, String destination, double price) {
	  ticket.add(new Trains(id, depart, destination, price));
	  addTrainList();
  }
